              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h4 class="card-title mb-0">Doosra Mauka Participants</h4>
                    <a href="../forms/AddStudents/add_DM_student.html" class="btn btn-success btn-sm">
                        <i class="mdi mdi-account-plus"></i> Add New Student
                    </a>
                    </div>
                    <p class="card-description"> Manage Doosra Mauka Students </p>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                                <a href="../forms/ViewStudents/view_DM_student.html" class="btn btn-info btn-sm" title="View">
                                  <i class="mdi mdi-eye"></i>
                                </a>
                                <a href="../forms/EditStudents/edit_DM_student.html" class="btn btn-warning btn-sm" title="Edit">
