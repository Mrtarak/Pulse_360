                ...
                <div class="col-12 grid-margin stretch-card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            /*
                            |--------------------------------------------------------------------------
                            | Check if this is the protected system role
                            |--------------------------------------------------------------------------
                            */

                            $isSystemRole = !empty($readOnly);
                            ?>
                            ...
                            <?php if ($isSystemRole): ?>
                                ...
                                <div
                                    class="alert alert-primary d-flex align-items-center mb-4"
                                    role="alert">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            ...
                                            Super Admin automatically has all active
                                            rights in the system. These rights cannot
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <?php if ($isSystemRole): ?>
                                                ...
                                                <p class="text-muted mb-0">
                                                    ...
                                                    All active rights are automatically
