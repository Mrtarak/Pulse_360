    ...
    $(document).ready(function() {
        ...
        $('#center_id').on('change', function() {
            ...
            $.ajax({
                ...
                url: '<?= site_url('assessment/learning-adda/get-batches') ?>',
        ...
        $('#fetchStudents').on('click', function() {
            ...
            $.ajax({
                ...
                url: '<?= site_url('assessment/learning-adda/get-students') ?>',
                    ...
                    $.each(students, function(index, student) {
                        ...
                        if (student.action === 'add') {
                            ...
                            actionHtml =
                                ...
                                '<a href="<?= site_url('assessment/learning-adda/add') ?>' +
                        ...
                        ================================================= */
                            ...
                            actionHtml =
                                ...
                                '<a href="<?= site_url('assessment/learning-adda/view') ?>/' +
                                ...
                                '<a href="<?= site_url('assessment/learning-adda/edit') ?>/' +
