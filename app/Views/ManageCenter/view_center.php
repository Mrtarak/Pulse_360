                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row view-details">
                            ...
                            <div class="col-md-12 mb-2 d-flex">
                                <div style="min-width: 200px;"><strong>Programs</strong> :</div>

                                <div class="ms-3">
                                    <?php
                                    if (!empty($programs)) {
                                        echo esc(implode(', ', array_column($programs, 'Program_Name')));
                                    } else {
                                        echo '<span class="text-muted">No Program Assigned</span>';
                                    }
                                    ?>
                                </div>
                            </div>
